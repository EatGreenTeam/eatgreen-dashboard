            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="button-holder">
                        ...
                        <button type="button" class="btn btn-blue navbar-btn" data-toggle="modal" data-target="#SignIn">Connexion</button>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 caption">
                    ...
                    <p> Vous pouvez nous faire confiance sans crainte </p>
                ...
                <div class="col-md-5 col-md-offset-1">
                    ...
                    <form class="signup-form">
                        ...
                        <div class="form-group text-center">
                            ...
                            <button type="submit" class="btn btn-blue btn-block">Soumettre</button>
